...
commit:
    git commit -m "$(uvx llm "Write a commit message for the following git diff. The message needs to be 7 words max. Keep it short and concise." <<< "$(git --no-pager diff)")"
